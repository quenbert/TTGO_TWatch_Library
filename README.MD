...
Updated/Forked TWatch Library to be compatible with latest Arduino ESP32 v3.x.x board core.
Original code is (here)[https://github.com/Xinyuan-LilyGO/TTGO_TWatch_Library].
